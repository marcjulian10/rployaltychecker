...
const featureMapping = {
  free: {
    ...
    // The specific fields you requested to be in Scraped Info results
...
const extraFields = {
  ...
  "PREPAY DASHBOARD": { expected: "Report" }, // Updated key and set to Report
  "Prepay From Dashboard": { expected: "YES" } // Catch-all
};
...
function getMainState(element, featureName) {
  ...
  // Looks in the cell directly below the header
  ...
  // Looks for a column named "Custom Value" in the same row
