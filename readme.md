AA Checker – Microsoft Edge Extension
...
✅ Features
    ...
    Compare target site settings against reference or predefined expectations.
    Export QA results as CSV.
    Direct error modules to their location on the page.
